    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          storeId: 5,
          categoryId: 5,
          name: 'Men’s Classic Bifold Wallet',
          slug: createSlug('Men’s Classic Bifold Wallet'),
          description:
            'A classic bifold leather wallet with multiple card slots.',
          price: 270000.0,
          stock: 300,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        },
        {
          ...
          slug: createSlug('Men’s RFID Blocking Wallet'),
          description: 'A modern wallet with RFID blocking technology.',
          price: 280000.0,
          stock: 350,
          createdAt: new Date(),
          updatedAt: new Date(),

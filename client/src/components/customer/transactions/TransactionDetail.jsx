      ...
      <DialogContent className="h-96 max-w-lg py-4 px-0 rounded-xl shadow-lg">
        ...
        {!transaction ? null : (
          <ScrollArea className="flex-1 overflow-y-auto  px-2">
            <TransactionOrderDetail transaction={transaction} />
            <TransactionPaymentDetail transaction={transaction} />
          </ScrollArea>
        )}
      </DialogContent>
    </Dialog>
...
const TransactionOrderDetail = ({ transaction }) => {
  return (
...
const TransactionPaymentDetail = ({ transaction }) => {
  return (
    <div className="p-4 rounded-md border mb-2">

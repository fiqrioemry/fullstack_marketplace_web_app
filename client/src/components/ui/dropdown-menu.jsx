  ...
  ({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-48 bg-background overflow-hidden rounded-md border text-popover-foreground shadow-md mr-4 p-1.5",
